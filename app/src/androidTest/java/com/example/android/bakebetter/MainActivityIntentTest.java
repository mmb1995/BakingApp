...
public class MainActivityIntentTest {
    @Rule
    public final IntentsTestRule<MainActivity> mActivityTestRule = new IntentsTestRule<MainActivity>(MainActivity.class);
    ...
    @Test
    public void checkIntent_LaunchesRecipeMasterActivity() {
        onView(ViewMatchers.withId(R.id.recipes_rv)).perform(RecyclerViewActions.actionOnItemAtPosition(0, click()));
        intended(hasComponent(RecipeMasterActivity.class.getName()));
    }
